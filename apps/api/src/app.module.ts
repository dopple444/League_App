...
import { InvitationTokenService } from './services/invitation-token.service.js';
import { PlatformMutationService } from './services/platform-mutation.service.js';
...
@Module({
  ...
  providers: [
    ...
    },
    {
      ...
      useFactory: () => new InvitationTokenService(required('BETTER_AUTH_SECRET')),
    },
    {
